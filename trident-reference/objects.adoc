...
| trident.netapp.io/cloneFromPVC | Volume cloneSourceVolume | ontap-nas, ontap-san, solidfire-san, aws-cvs, azure-netapp-files, gcp-cvs, ontap-san-économie 
...
| trident.netapp.io/snapshotReserve | Réserve de snapshots | ontap-nas, ontap-nas-flexgroup, ontap-san, aws-cvs, gcp-cvs 
...
ontap-nas, économie ontap-nas, ontap-nas-flexgroup, ontap-san, solidfire-san, eseries-iscsi, aws-cvs, gcp-cvs, azure-netapp-files, ontap-san-économie
| Le pool appartient à ce type de système back-end | Backend spécifié | Tous les conducteurs 


| snapshots | bool | vrai, faux | Le pool prend en charge les volumes dotés de snapshots | Volume sur lequel les snapshots sont activés | ontap-nas, ontap-san, solidfire-san, aws-cvs, gcp-cvs 


| clones | bool | vrai, faux | Le pool prend en charge les volumes de clonage | Volume sur lequel les clones sont activés | ontap-nas, ontap-san, solidfire-san, aws-cvs, gcp-cvs 
...
| Fstype | chaîne | ext4, ext3, xfs, etc | Type de système de fichiers pour les volumes en mode bloc | solidfire-san, ontap-san, ontap-san-economy, eseries-iscsi | Tout 
|===
...
| Volume cloneSourceVolume | chaîne | non | ONTAP (nas, san) et SolidFire-* et aws-cvs* : nom du volume à cloner 
