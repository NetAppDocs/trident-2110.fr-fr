...
Astra Trident inclut désormais la prise en charge par défaut des volumes plus petits link:https://cloud.google.com/architecture/partners/netapp-cloud-volumes/service-types["Type de service CVS sur GCP"^]. Pour les systèmes back-end créés avec `storageClass=software`, Les volumes auront une taille de provisionnement minimale de 300 Gio. CVS offre actuellement cette fonctionnalité sous disponibilité contrôlée et ne fournit pas de support technique. Les utilisateurs doivent s'inscrire pour accéder aux volumes de sous-Tio https://docs.google.com/forms/d/e/1FAIpQLSc7_euiPtlV8bhsKWvwBl3gm9KUL4kOhD7lnbHC3LlQ7m02Dw/viewform["ici"^]. NetApp recommande aux clients d'utiliser des volumes de sous-Tio pour **charges de travail non-production**.
